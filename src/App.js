...
function App() {
  ...
  return (
    <div data-theme={theme} className='bg-main'>
      <section id='hi'>
        <div
          className='hero lg:min-h-screen bg-transparent flex-row justify-between'
          style={{
            display: "flex",
          }}
        >
          <div
            className='rotate-180 bg-transparent text-white px-2 h-screen'
            style={{ writingMode: "vertical-rl" }}
          >
            <a
              className='font-mono transition ease-in-out delay-50 hover:text-violet-400 my-6 text-blue-300'
            ...
            <a
              className='font-mono transition ease-in-out delay-50 hover:text-violet-400 my-6 text-blue-300'
              href='https://youtube.com/acodingwoof'
              target='_blank'
              rel='noreferrer'
            >
              YOUTUBE
              ...
              <div>
                <div>
                  ...
                  <p className=' py-10 text-justify ' ref={ref}>
                    ...
                    started a web development agency, WebTrope.
                  </p>
                </div>
      ...
      <section id='freelance-listings' className='bg-main'>
        <header
        ...
        <FreelanceOffer
          title={
            <>
              <span className='text-primary'>WebTrope</span> Web Development
              Agency
            </>
          }
          description="At WebTrope, we believe that every business, regardless of its size, should have a professional online presence. That's why we work closely with our clients to create custom websites that perfectly capture their unique vision and brand. Whether you're a small business owner, a blogger, or an individual looking to showcase your work online, our team has the skills and expertise to bring your vision to life."
          image={landingPage}
          link='
          https://webtrope.github.io
          '
          flex='flex-col'
        />
      </section>

      <section id='projects' className='bg-main'>
        <header
...
function Project(props) {
  ...
  return (
    <>
      <div className='hero py-32 lg:min-h-screen bg-base-300 backdrop-filter backdrop-blur-sm bg-opacity-50'>
...
function FreelanceOffer(props) {
  ...
  return (
    <>
      <div className='hero py-32 lg:min-h-screen bg-base-100 backdrop-filter backdrop-blur-sm bg-opacity-50'>
        <div className={`px-26 hero-content ${flex} lg:flex-col lg:gap-24`}>
          <div>
            <h1 className='text-5xl font-bold' ref={ref}>
              {title}
